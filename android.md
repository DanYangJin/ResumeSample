...
- 责任描述：团队项目，承担该项目主要负责人，主要负责项目主体框架搭建，点播模块，通讯模块，项目打包，需求分析，组织bug修复。其中项目主体框架采用android5.0特性，项目导航栏采用AppBar实现导航与内容的联动。
...
- 责任描述：团队项目，主要负责搭建项目的基础框架，网络框架基于volley上层封装活动专区的实现，图片框架使用开源的Android-Universal-Image-Loader。
负责项目百分之八十以上的功能开发
